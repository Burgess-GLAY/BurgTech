  ...
  return (
    <div className="pt-20">
      ...
      <div className="section-pad text-center">
        <span className="text-bt-cyan text-sm font-medium tracking-wide uppercase">Partnerships</span>
      ...
      <section className="px-4 md:px-8 max-w-4xl mx-auto mb-20">
        <div className="glass-card p-10 md:p-14 text-center">
          <div className="w-20 h-20 rounded-2xl bg-bt-cyan/10 border border-bt-cyan/20 flex items-center justify-center mx-auto mb-6">
            <Handshake className="w-10 h-10 text-bt-cyan" />
          </div>
          ...
          <Link href="/contact"
            className="inline-flex items-center gap-2 px-8 py-4 bg-bt-cyan text-bg-primary font-bold rounded-xl hover:bg-bt-cyan-light transition-colors text-sm md:text-base">
      ...
      <section className="section-pad border-t border-white/[0.06]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="glass-card p-8 text-center md:text-left">
            <div className="w-14 h-14 rounded-xl bg-bt-cyan/10 border border-bt-cyan/20 flex items-center justify-center mb-6 mx-auto md:mx-0">
              <Globe className="w-7 h-7 text-bt-cyan" />
            </div>
          ...
          <div className="glass-card p-8 text-center md:text-left">
            <div className="w-14 h-14 rounded-xl bg-bt-teal/10 border border-bt-teal/20 flex items-center justify-center mb-6 mx-auto md:mx-0">
              <GraduationCap className="w-7 h-7 text-bt-teal" />
            </div>
