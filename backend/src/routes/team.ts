...
teamRouter.post('/', requireAuth, requireAdmin, auditLog('TeamMember'), async (req: Request, res: Response) => {
...
teamRouter.put('/:id', requireAuth, requireAdmin, auditLog('TeamMember'), async (req: Request, res: Response) => {
...
teamRouter.delete('/:id', requireAuth, requireAdmin, auditLog('TeamMember'), async (req: Request, res: Response) => {
