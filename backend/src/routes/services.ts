...
servicesRouter.post('/', requireAuth, requireAdmin, auditLog('Service'), async (req: Request, res: Response) => {
...
servicesRouter.put('/:id', requireAuth, requireAdmin, auditLog('Service'), async (req: Request, res: Response) => {
...
servicesRouter.delete('/:id', requireAuth, requireAdmin, auditLog('Service'), async (req: Request, res: Response) => {
