...
testimonialsRouter.post('/', requireAuth, requireAdmin, async (req: Request, res: Response) => {
...
testimonialsRouter.put('/:id', requireAuth, requireAdmin, async (req: Request, res: Response) => {
...
testimonialsRouter.delete('/:id', requireAuth, requireAdmin, async (req: Request, res: Response) => {
